...
import com.auro.application.ui.features.login.screens.ConfirmRecoverAccountBottomSheet
...
//        message = "Loading your data..."
    ...
    if (confirmRecoverState) {
        ConfirmRecoverAccountSwitchBottomSheet(
            navController, viewModel, isDialogVisible, viewModel.getUserPhoneNo()
        ) {
    ...
    BackHandler {
        if (viewModel.getParentInfo()!!.isParent) {
            startActivity(
                context,
...
//                        stringResource(id = R.string.please_enter_your_pin_to_proceed),
                ...
                Column(
                    ...
                    /*Text(
                        ...
                        textAlign = TextAlign.Center, // Add this line to align the text to the right
                        fontStyle = FontStyle.Normal,
                    ...
                    BtnUi(
                        ...
                        onClick = {
                            if (isOtpFilled) {
                                isDialogVisible = true
                                val encryptedPhoneNo = viewModel.getUserPhoneNo().encryptAES()
                    ...
                    if (showBottomSheet) {
                        BottomSheetAlert(
                            ...
                            Column(
                                ...
                                Text(/*"Oops!"*/ languageData[LanguageTranslationsResponse.KEY_OOPS].toString(),
                                    color = PrimaryBlue
                                )
                                Text(
...
@Composable
fun ConfirmRecoverAccountSwitchBottomSheet(
    navController: NavHostController,
    ...
    if (verifyOTPSheet) {
        VerifyOtpPINSwitchBottomSheet(navController, phoneNo, viewModel, context) {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun VerifyOtpPINSwitchBottomSheet(
    navController: NavHostController,
    phoneNo: String,
    viewModel: LoginViewModel,
    context: Context,
...
//    var invalidOtpText = stringResource(id = R.string.invalid_OTP)
    ...
    if (successSheet) {
        SuccessRecoverSwitchBottomSheet(navController, successTitle, successMessage, viewModel) {
            successSheet = false
        }
    }
    LaunchedEffect(Unit) {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SuccessRecoverSwitchBottomSheet(
    navController: NavHostController,
    title: String,
    description: String,
    viewModel: LoginViewModel,
